            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <Link href="/admin/blogs" className="group">
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all border-l-4 border-l-purple-600 h-full flex flex-col">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 mb-3">Manage Blogs</h2>
