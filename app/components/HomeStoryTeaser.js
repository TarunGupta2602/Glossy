...
import { HOME_CONTAINER, HOME_SECTION_Y_SOFT, HOME_SURFACE_IVORY, HOME_SURFACE_EDGE } from "@/lib/siteLayout";
...
export default function HomeStoryTeaser() {
    return (
        <section className={`${HOME_SURFACE_IVORY} ${HOME_SECTION_Y_SOFT} ${HOME_SURFACE_EDGE}`}>
