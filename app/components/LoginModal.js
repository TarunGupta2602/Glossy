            ...
            <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-8 z-10 animate-in zoom-in-95 duration-300 overflow-hidden">
                ...
                <div className="relative flex flex-col items-center text-center space-y-6">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-100 py-3.5 px-6 rounded-2xl shadow-sm hover:bg-gray-50 hover:border-gray-200 transition-all group active:scale-[0.98]"
                    >
                    ...
                    <button
                        onClick={onClose}
                        className="text-[11px] font-bold uppercase tracking-widest text-gray-400 hover:text-gray-600 transition-colors"
                    >
                        Maybe Later
                    </button>
                </div>
