...
export default function Footer() {
    ...
    return (
        <footer className="relative bg-gradient-to-b from-white via-[#fffafa] to-[#f9f9fb] border-t border-gray-100/50 pt-14 md:pt-24 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] md:pb-12 overflow-hidden">
            {/* Decorative element */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 lg:gap-16 pb-12 md:pb-20 border-b border-gray-100">
                    ...
                    <div className="md:col-span-5 lg:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="space-y-1">
                            <a href={`tel:${SUPPORT_PHONE.replace(/\s/g, "")}`} className="flex items-center gap-3 min-h-11 text-gray-600 hover:text-[#E91E63] transition-colors">
                            ...
                            <a href={`mailto:${SUPPORT_EMAIL}`} className="flex items-center gap-3 min-h-11 text-gray-600 hover:text-[#E91E63] transition-colors">
                                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span className="text-sm font-medium">{SUPPORT_EMAIL}</span>
                            </a>
                            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 min-h-11 text-gray-600 hover:text-[#25D366] transition-colors">
