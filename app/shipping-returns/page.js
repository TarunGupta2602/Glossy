    ...
    return (
        <>
                ...
                <LegalSection title="Need Help?">
                    <p>
                        ...
                        <a
                            ...
                            className="font-medium text-gray-900 hover:text-[#E91E63] transition-colors"
                        >
                            {SUPPORT_EMAIL}
                        </a>
                        .
            ...
            <SiteFaqSection
                ...
                description="Delivery timelines, free shipping, returns, and what to do if a package arrives damaged."
                idPrefix="shipping-faq"
            />
        </>
    );
}
