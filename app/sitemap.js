...
export default async function sitemap() {
    ...
    const staticRoutes = [
        ...
        { path: "/jewellery-shop", priority: 0.75, changeFrequency: "monthly", lastModified: LEGAL_LAST_MODIFIED },
        { path: "/jewellery-shop/noida", priority: 0.8, changeFrequency: "monthly", lastModified: LEGAL_LAST_MODIFIED },
        { path: "/jewellery-shop/greater-noida", priority: 0.75, changeFrequency: "monthly", lastModified: LEGAL_LAST_MODIFIED },
        { path: "/jewellery-shop/ghaziabad", priority: 0.75, changeFrequency: "monthly", lastModified: LEGAL_LAST_MODIFIED },
        { path: "/jewellery-shop/delhi-ncr", priority: 0.8, changeFrequency: "monthly", lastModified: LEGAL_LAST_MODIFIED },
