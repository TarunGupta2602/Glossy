...
export const BLOG_SEO_OVERRIDES = {
    ...
    "18k-gold-plated-vs-real-gold-jewelry": {
        // GSC: "18k gold plated means" variants — answer-first for CTR
        meta_title: "18k Gold Plated Means? Real Gold or Not",
        meta_description:
            "18k gold plated means a real 18-karat gold layer over base metal — not solid gold. See value, fade risk, and when anti-tarnish plating is worth it in India.",
        h1: "What Does 18k Gold Plated Mean? Real Gold or Not",
        content_prefix: `**18k gold plated means** the jewellery is coated with an 18-karat gold alloy (about 75% pure gold mix) over a base metal. It gives a real gold colour and feel — but it is **not** solid hallmarked gold throughout.

If you searched “18k gold plated means” or “is 18k gold plated real gold,” here is the short answer: **real gold on the surface, fashion jewellery underneath.** Buy it for everyday style and gifts; buy solid gold when you want an investment metal.
...
`,
    ...
    "15-best-bracelets-for-daily-wear-in-india-2026-gold-silver-fashion": {
        // GSC: "best bracelets for daily wear" — drop cuffs-first title
        meta_title: "Best Bracelets for Daily Wear India 2026",
        meta_description:
            "Best bracelets for daily wear in India 2026 — lightweight anti-tarnish chains, slim bangles & comfortable everyday bracelets for women.",
        h1: "Best Bracelets for Daily Wear in India (2026)",
        faqs: [
            {
            ...
            },
            {
                ...
                answer:
                    "Yes — if they are anti-tarnish and waterproof. Avoid thick, heavy pieces for all-day wear; choose fine chains and soft finishes instead.",
            },
            {
                question: "What bracelet is best for office and college daily wear?",
                answer:
                    "Slim chain bracelets and soft anti-tarnish bangles stay comfortable through humid days and pair with both ethnic and western outfits.",
            },
        ],
    },
    "25-perfect-gift-ideas-for-girlfriend-under-299-that-shell-actually-love": {
        // GSC: best budget / affordable gift for girlfriend
        meta_title: "Best Budget Girlfriend Gifts Under ₹299",
        meta_description:
            "Best budget gifts for girlfriend under ₹299 — cute anti-tarnish earrings & mini jewellery she’ll wear. Also see under ₹499 & ₹999 picks in India.",
