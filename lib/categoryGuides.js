...
export const EARRINGS_GUIDE = {
    title: "How to buy anti-tarnish waterproof earrings in India",
    intro:
        "Looking for anti-tarnish waterproof earrings for daily wear? The right pair should survive humidity, workouts, and festive weeks without turning dull. Use this short guide before you add to bag.",
    sections: [
        {
...
export const NECKLACES_GUIDE = {
    title: "How to choose anti-tarnish necklaces for daily wear",
    intro:
        "Shop waterproof anti-tarnish necklaces for everyday India — a good chain or pendant should layer easily, sit comfortably on kurtas and western wear, and stay bright through humidity. Here’s how to choose.",
    sections: [
        {
