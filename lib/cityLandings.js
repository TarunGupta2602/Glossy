...
const CITIES = {
    noida: {
        name: "Noida",
        slug: "noida",
        title: "Jewellery Shop in Noida | Anti-Tarnish Everyday Wear",
        description:
            "Looking for a jewellery shop in Noida? The Luxe Jewels offers anti-tarnish waterproof 18k gold plated earrings, necklaces & more — with pan-India shipping and Buy 2 Get 1 Free.",
        h1: "Jewellery shop in Noida for everyday anti-tarnish wear",
        intro:
            "If you are searching for a jewellery shop in Noida that understands real daily wear — metro humidity, office days, and festive evenings — The Luxe Jewels is built for that brief. We specialise in lightweight anti-tarnish, waterproof 18k gold plated jewellery you can live in.",
        nearby: ["Greater Noida", "Ghaziabad", "Delhi NCR"],
    },
    "greater-noida": {
        name: "Greater Noida",
        slug: "greater-noida",
        title: "Jewellery Shop in Greater Noida | Anti-Tarnish Picks",
        description:
            "Shop anti-tarnish jewellery in Greater Noida online with The Luxe Jewels — waterproof earrings & necklaces, Buy 2 Get 1 Free, and shipping across India.",
        h1: "Anti-tarnish jewellery for Greater Noida shoppers",
        intro:
    ...
    ghaziabad: {
        name: "Ghaziabad",
        slug: "ghaziabad",
        title: "Jewellery Shop in Ghaziabad | Waterproof Daily Wear",
        description:
            "Discover anti-tarnish waterproof jewellery for Ghaziabad — 18k gold plated earrings and necklaces from The Luxe Jewels with Buy 2 Get 1 Free.",
        h1: "Jewellery shop serving Ghaziabad everyday wear",
        intro:
    ...
    "delhi-ncr": {
        name: "Delhi NCR",
        slug: "delhi-ncr",
        title: "Jewellery Shop in Delhi NCR | Anti-Tarnish Online Store",
        description:
            "The Luxe Jewels is an online jewellery shop for Delhi NCR — anti-tarnish waterproof earrings, necklaces & gift edits with Buy 2 Get 1 Free.",
