...
const CITIES = {
    noida: {
        name: "Noida",
        slug: "noida",
        title: "Luxe Jewels Noida — Online Jewellery, Sector 18",
        description:
            "Luxe Jewels Noida: online anti-tarnish jewellery from the Sector 18 area — waterproof earrings & necklaces, WhatsApp help, Buy 2 Get 1 Free, pan-India shipping.",
        h1: "Luxe Jewels Noida — online jewellery from Sector 18",
        intro:
            "Searching for Luxe Jewels Noida or jewellery near Sector 18? We are an online jewellery store based in Noida — not a wholesale counter. Shop anti-tarnish waterproof earrings and necklaces for metro humidity, office days, and festive evenings, then message us on WhatsApp if you want help picking a pair. Prepaid checkout, complimentary wrap, and delivery across India.",
...
export function CityLandingPage({ city }) {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: isNoida
                ? "We are an online jewellery store based in Noida (Sector 18 area) — not a walk-in wholesale counter. Shop on theluxejewels.in, WhatsApp us for help picking a pair, and we ship pan-India."
        ...
        ...(isNoida
            ? [
                  {
                      question: "Are you a jewellery importer or wholesaler in Noida?",
                      answer:
                          "No. Luxe Jewels is a retail online store for anti-tarnish fashion jewellery — not an importer/wholesaler. Search “luxe jewels noida” or “sector 18 noida jewellery” and this page is the official listing: WhatsApp support, prepaid checkout, pan-India delivery.",
                  },
                  {
                      question: "Do you have a Sector 18 Noida showroom?",
                      answer:
                          "We operate online from the Sector 18 area of Noida. There is no wholesale counter. Message us on WhatsApp if you want help choosing earrings or a necklace before you order.",
                  },
              ]
            : []),
        {
        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="bg-[#fdfbf7] border-b border-[#efeae4]">
                <div className={`${HOME_CONTAINER} py-14 md:py-20`}>
                    ...
                    <p className="mt-6 text-[12px] text-[#8a847c]">
                        {isNoida
                            ? `Online from Noida, Sector 18 area · ${BUSINESS_HOURS} · pan-India delivery`
            ...
            <section className={`${HOME_CONTAINER} py-12 md:py-16`}>
                ...
                <ul className="space-y-3 text-[15px] text-[#6b6560] max-w-2xl">
                    ...
                    {isNoida && (
                        <li>
                            WhatsApp before you buy — we are a retail online store from Sector 18, Noida, not a wholesale counter
                        </li>
                    )}
                </ul>
            ...
            <RelatedGuides
                page="city"
                title={`Shop and read from ${city.name}`}
            />
