...
export const HOME_FAQS = [
    {
        ...
        answer:
            "The Luxe Jewels (also called Luxe Jewels) is an Indian online jewellery brand based around Noida and Delhi NCR. We sell anti-tarnish, waterproof 18k gold plated fashion jewellery for everyday wear — earrings, necklaces, bracelets, and rings — with Buy 2 Get 1 Free and pan-India prepaid shipping. Pieces are fashion jewellery, not solid or hallmarked gold.",
    },
    {
...
export const CONTACT_FAQS = [
    ...
    {
        question: "Are you a jewellery shop in Noida / Sector 18?",
        answer:
            "Luxe Jewels is an online jewellery store based in Noida (Sector 18 area) — not a wholesale counter. WhatsApp us for help picking a pair; we ship prepaid across India.",
    },
];
