...
export const PROMO_SHORT =
    "Buy any 2 pieces and receive a complimentary gift with your order.";
export const PROMO_DETAIL =
    "Choose any two paid pieces and we’ll add a complimentary gift from our collection. Mix and match across earrings, necklaces, bracelets, and more — every additional two paid items unlocks another complimentary gift.";
